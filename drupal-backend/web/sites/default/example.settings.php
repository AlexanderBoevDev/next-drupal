...
# $settings['form_cache_expiration'] = getenv('form_cache_expiration');
 ...
 */
# $settings['file_chmod_directory'] = getenv('FILE_CHMOD_DIRECTORY');
# $settings['file_chmod_file'] = getenv('FILE_CHMOD_FILE');
 ...
 */
# $settings['file_public_base_url'] = getenv('FILE_PUBLIC_BASE_URL');
 ...
 */
# $settings['file_temp_path'] = getenv('FILE_TEMP_PATH');
 ...
 */
#$settings['session_write_interval'] = getenv('SESSION_WRITE_INTERVAL');
 ...
 */
$settings['maintenance_theme'] = getenv('MAINTENANCE_NAME_THEME');
 ...
 */
#$settings['entity_update_batch_size'] = getenv('ENTITY_UPDATE_BATCH_SIZEs');
...
if (file_exists($app_root . '/' . $site_path . '/settings.local.php') && getenv('SETTINGS_LOCAL') == 1) {
